...
<html lang="en">
  <head>
    ...
    <!-- Animate.css -->
    <link href="{{asset('vendors/backend_vendor/animate.css/animate.min.css')}}" rel="stylesheet">
          ...
          <section class="login_content">
            <form>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Counseling System</h1>
                  <p>©2019 All Rights Reserved. Counseling System. Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
